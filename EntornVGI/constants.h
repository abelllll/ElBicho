...
#define TEXTURA_CAP         0   // Sense textura / per defecte
#define TEXTURA_BRICKS      1   // brick.jpg
#define TEXTURA_MAPA_MUNDI  2   // world-politicalmap-with-countries.jpg
#define TEXTURA_SAC         3   // sac.jpg
